...
# Package is basic unit of R reusability
# EVery package must have decription file & R directory containng Code, created by US
# NAMESPACE file is needed as well, & main directory containing documentation but both can be autogenerated